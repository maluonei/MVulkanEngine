...
{
    setShader(shader);
    CreatePipeline(allocator, storageBufferSizes, storageImageViews, seperateImageViews, samplers, accelerationStructures);
}
...
void ComputePass::CreatePipeline(MVulkanDescriptorSetAllocator& allocator,
    std::vector<uint32_t> storageBufferSizes, std::vector<std::vector<VkImageView>> storageImafeViews,
    std::vector<std::vector<VkImageView>> seperateImageViews, std::vector<VkSampler> samplers, std::vector<VkAccelerationStructureKHR> accelerationStructures)
{
    MVulkanShaderReflector compReflector(m_shader->GetComputeShader().GetShader());
...
void ComputePass::UpdateDescriptorSetWrite(std::vector<std::vector<VkImageView>> storageImageViews, std::vector<std::vector<VkImageView>> seperateImageViews, std::vector<VkSampler> samplers, std::vector<VkAccelerationStructureKHR> accelerationStructures)
{
    MVulkanDescriptorSetWrite write;
